...
- **Project & Issue Management**
  ...
  - Import issues from GitHub into a selected project
...
4. Choose `GitHub` and fill connection details.
...
- `import-proxy.js`: Local proxy server for GitHub issue import
